import{j as e}from"./index-CMUI_d-s.js";const i={title:"A 3-bit Flash ADC from NAND3 Gates and a Resistor Ladder",date:"2021-07-01",description:"Extending the NAND-comparator concept into a full 3-bit Flash ADC using a resistor voltage divider and eight comparator stages.",tags:["EE","ADC","Analog","7400-series"]};function s(r){const t={a:"a",code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Introduction"}),`
